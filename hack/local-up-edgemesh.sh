...
localup_kubeedge() {
  ...
  sudo -E keadm init --advertise-address=127.0.0.1 --kubeedge-version=1.7.1 --kube-config=${KUBECONFIG}
  ...
  sudo -E keadm join --cloudcore-ipport=127.0.0.1:10000 --kubeedge-version=1.7.1 --token=${token} --edgenode-name=${EDGE_NODENAME}
